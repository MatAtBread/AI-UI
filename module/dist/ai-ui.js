...
const tag = function (_1, _2, _3) {
    ...
    */
    ...
    function deepCopy(d) {
        ...
        (0,_debug_js__WEBPACK_IMPORTED_MODULE_4__.log)("Declared propety is not a plain object and must be assigned by reference");
        return d;
    }
            ...
            if (elt.id) {
                if (!ids[elt.id])
                    ...
                    if (!warned.has(elt.id)) {
                        warned.add(elt.id);
                        (0,_debug_js__WEBPACK_IMPORTED_MODULE_4__.log)('(AI-UI)', "Shadowed multiple element IDs", elt.id, elt, ids[elt.id]);
                    }
                }
            }
        });
