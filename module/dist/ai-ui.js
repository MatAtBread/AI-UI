          ...
          get(target, key, receiver) {
            if (Object.hasOwn(pds, key)) {
              if (!path.length) {
                ...
                let ai = filterMap(withPath, (o, p2) => {
