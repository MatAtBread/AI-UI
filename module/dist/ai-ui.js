  ...
  var elementProtype = Object.getOwnPropertyDescriptors({
    get ids() {
      ...
      return new Proxy(/* @__PURE__ */ Object.create(null), {
        ...
        has(target, p) {
          return typeof p === "string" && Boolean(elt.querySelector(`#${p}`));
        },
        get(target, p) {
          return typeof p === "string" ? elt.querySelector(`#${p}`) : null;
        },
        preventExtensions() {
          return false;
        },
