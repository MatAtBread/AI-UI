    ...
    */
    ...
    function extended(_overrides) {
        const overrides = (typeof _overrides !== 'function')
            ? (instance) => Object.assign({}, _overrides, { [_tags_js__WEBPACK_IMPORTED_MODULE_3__.UniqueID]: uniqueTagID })
            : _overrides;
        const uniqueTagID = Date.now().toString(36) + (idCount++).toString(36) + Math.random().toString(36).slice(2);
        let staticExtensions = overrides({ [_tags_js__WEBPACK_IMPORTED_MODULE_3__.UniqueID]: uniqueTagID });
        ...
        const extendTagFn = (attrs, ...children) => {
            ...
            const tagDefinition = overrides({ [_tags_js__WEBPACK_IMPORTED_MODULE_3__.UniqueID]: uniqueTagID });
        ...
        const extendTag = Object.assign(extendTagFn, {
            super: this,
            overrides: Object.assign(staticExtensions, { [_tags_js__WEBPACK_IMPORTED_MODULE_3__.UniqueID]: uniqueTagID }),
            extended,
            valueOf: () => {
