...
* An **async generator** is a function that returns an **async iterator** when it is invoked.
...
| < Prev | ^ |  Next > |
|:-------|:-:|--------:|
| [Dynamic Content](./dynamic-attributes.md) | [Index](./index.md) | [Create new tags](./extended-1.md) |
